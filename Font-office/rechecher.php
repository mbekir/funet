...
$result = mysqli_query($db, "SELECT * FROM membre where nom='$rech'");
            ...
            <div class="friend-list">
                ...
                <?php
                  ...
                  <div class="friend-card">
                    <?php echo " <img alt='profile-cover' class='img-responsive cover'  src='avatar/Couverture/".$ligne[9]."' >";?>


                  	<div class="card-info">

                    <?php echo " <img alt='profile-cover' class='profile-photo-lg'  src='avatar/Profile/".$ligne[8]."' >";?>
                      <div class="friend-info">
                        <a href="#" class="pull-right text-green">My Friend</a>
            <h5><a href="timeline.html" class="profile-link"><?php echo $ligne[3]." ".$ligne[4]; ?></a></h5>
                      </div>
                    </div>
                  </div>
                </div>
